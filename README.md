...
TX	GPIO16 (RX)
Software Setup
Arduino IDE + ESP32 board (2.0.17+)

Libraries: Keypad, TM1637Display, DFRobotDFPlayerMini

Get MACs: Flash one, open Serial Monitor → WiFi.macAddress()

Update MACs in codes

SD Card (FAT32): /01/0001.mp3 ("Token zero zero zero one"), etc.
